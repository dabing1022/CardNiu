...
@synthesize cardsDataArr=_cardsDataArr,selectedCardsDataArr=_selectedCardsDataArr,sendToServerArr=_sendToServerArr;
@synthesize cardType=_cardType,winCoinTB=_winCoinTB;
